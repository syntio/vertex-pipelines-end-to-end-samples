...
if __name__ == "__main__":
    ...
    print("Running DQ scan directly from script...")
    ...
    try:
        ...
        end_date='2014-09-05',
        dq_scan_id = f"chicago-tax-dq-test-{timestamp}"
        )
        print("🎉 DQ scan finished successfully!")
    except Exception as e:
        print(f"❌ An error occurred during the DQ scan: {e}")
